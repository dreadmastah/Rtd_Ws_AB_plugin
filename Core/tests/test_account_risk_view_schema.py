...
assert schema["properties"]["orderRoutingEnabled"]["type"] == "boolean"
assert "executionEnvironment" in schema["required"]
...
assert execution_schema["properties"]["orderRoutingEnabled"]["type"] == "boolean"
assert "executionEnvironment" in execution_schema["required"]
